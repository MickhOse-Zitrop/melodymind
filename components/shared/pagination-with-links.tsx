...
export function PaginationWithLinks({
  ...
  const navToPageSize = useCallback(
    (newPageSize: number) => {
      ...
      newSearchParams.delete(pageSearchParam || "page"); // Clear the page number when changing the page size
  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-3 w-full">
      ...
      <Pagination
        className={cn({ "md:justify-end": pageSizeSelectOptions }, className)}
      >
