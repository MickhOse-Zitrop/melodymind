...
$id = (int)$dData['id'];
$soundCloud = $dData['soundCloud'];
$youtube = $dData['youtube'];
$rutube = $dData['rutube'];
$tiktok = $dData['tiktok'];
$twitch = $dData['twitch'];
...
if (!mysqli_fetch_assoc($sql)) {
    ...
    $sql = "UPDATE `users` SET `soundCloud` = '$soundCloud', `youtube` = '$youtube', `rutube` = '$rutube', `tiktok` = '$tiktok', `twitch` = '$twitch' WHERE `users`.`id` = $id";
